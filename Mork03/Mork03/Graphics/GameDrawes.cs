...
namespace Mork {
    public partial class Main {
        ...
        private static void MainMenuDraw(GameTime gt, SpriteBatch sb, GraphicsDevice GraphicsDevice) {
            ...
            spriteBatch.Draw(gears[1], new Vector2(resx/3, resy/3 - resy/12), null, Color.White, rotation,
                             new Vector2(g2r), 0.5f, SpriteEffects.None, 0);
            spriteBatch.Draw(gears[1], new Vector2(resx/3 - 20, resy/3 - resy/12 + g2r - 20), null, Color.White*0.5f,
                             - rotation + 0.1f, new Vector2(g2r), 0.5f, SpriteEffects.None, 0);

            _titleAnimation += (float) (_titlePhase*gt.ElapsedGameTime.TotalSeconds);
            if (_titleAnimation >= 1 || _titleAnimation <= 0) {
                _titlePhase *= -1;
            }
